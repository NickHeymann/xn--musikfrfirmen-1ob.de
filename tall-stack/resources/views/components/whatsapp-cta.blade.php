...
<section id="kontakt" class="whatsapp-cta-section w-full py-20 bg-[#2DD4A8]" style="font-family: 'Poppins', sans-serif" data-section-bg="#2DD4A8" data-section-theme="dark">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        {{-- CTA Button --}}
        <a
            href="https://wa.me/491746935533?text=Hallo%2C%20ich%20interessiere%20mich%20f%C3%BCr%20Musik%20f%C3%BCr%20mein%20Firmenevent."
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center gap-3 bg-white text-[#1a1a1a] px-10 py-4 rounded-full font-semibold text-lg hover:bg-[#f0f0f0] hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 uppercase tracking-wide mb-8"
        >
