...
<footer id="kontakt" class="bg-[#1a1a1a] scroll-mt-[80px] lg:scroll-mt-[108px]" data-section-bg="#1a1a1a" data-section-theme="dark" style="font-family: 'Poppins', sans-serif">
