...
<div class="w-full">
    ...
    <section id="waswirbieten" class="bg-white scroll-mt-[80px] lg:scroll-mt-[108px]">
        <x-service-cards />
    </section>
    ...
    {{-- Team Section --}}
    <section id="ueberuns" class="bg-white scroll-mt-[80px] lg:scroll-mt-[108px]">
        <x-team-section />
    </section>

    {{-- FAQ Section --}}
    <section id="faq" class="pt-24 pb-16 bg-white scroll-mt-[80px] lg:scroll-mt-[108px]" data-section-bg="#ffffff" data-section-theme="light">
