                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="50%" valign="top" style="padding-right: 20px;">
                            ...
                            <div style="font-size: 16px; font-weight: 600; color: #1a1a1a; padding-bottom: 5px; line-height: 1.4;">{{ $data['name'] }}</div>
                            <div style="font-size: 14px; color: #555; padding-bottom: 6px; line-height: 1.5;">{{ $data['company'] }}</div>
                            <div style="padding-bottom: 5px;">
                                <a href="mailto:{{ $data['email'] }}" style="font-size: 14px; color: #A0C4B5; text-decoration: none; line-height: 1.5;">{{ $data['email'] }} &#x2197;</a>
                            </div>
                            @if($data['phone'])
                            <div>
                                <a href="tel:{{ $data['phone'] }}" style="font-size: 14px; color: #A0C4B5; text-decoration: none; line-height: 1.5;">{{ $data['phone'] }} &#x2197;</a>
                            </div>
                            @endif
                        </td>
                        ...
                        <td width="50%" valign="top" style="padding-left: 20px; border-left: 1px solid #eee;">
                            <div style="font-size: 11px; font-weight: 700; color: #999; text-transform: uppercase; letter-spacing: 0.8px; padding-bottom: 10px;">EVENT</div>
                            ...
                            <div style="font-size: 14px; color: #555; padding-bottom: 5px; line-height: 1.5;">{{ $data['city'] }}</div>
                            <div style="font-size: 14px; color: #555; padding-bottom: 5px; line-height: 1.5;">{{ $guestLabels[$data['guests']] ?? $data['guests'] }} Gäste</div>
                            <div style="font-size: 14px; color: #1a1a1a; font-weight: 600; line-height: 1.5;">
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="padding-right: 10px;">
                            <a href="mailto:{{ $data['email'] }}?subject=Re: Ihre Anfrage für {{ $data['city'] }}" style="display: inline-block; background: #B0D4C5; color: #1a1a1a; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 600;">&#x2709; Antworten</a>
                        </td>
                        @if($data['phone'])
                        <td>
                            <a href="tel:{{ $data['phone'] }}" style="display: inline-block; background: #1a1a1a; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 600;">&#x1F4DE; Anrufen</a>
                        </td>
                        @endif
                    </tr>
                </table>
